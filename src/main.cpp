...
const string strMessageMagic = "HeadShot Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // HeadShot: 1 days
static const int64 nTargetSpacing = 120; // HeadShot: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal headshot miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HeadShot", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3fa9878a9a5cc6f7e6cf3fff73c51da8b107eb7c90bbcebbecc3949d508d63f0");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "January 29th Headshot Gaming League Launched";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1485705249; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1485705249;
            block.nNonce   = 2020438;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfea2df547430aa35e1dea099f9b9fe50deeacc7c2e39ad4d50b2acb3b8c4ab02"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Learncoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
